...
def text(message):
    ...
    if message.text == "💳 Купить":
        ...
        kricev = types.InlineKeyboardButton(text='Кричев', callback_data='kricev')
